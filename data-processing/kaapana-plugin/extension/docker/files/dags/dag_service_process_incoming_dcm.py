...
upload_to_data_api = LocalDataApiUploadOperator(
    dag=dag,
    metadata_dir=extract_metadata.operator_out_dir,
    thumbnail_dir=generate_thumbnail.operator_out_dir,
    validation_dir=validate.operator_out_dir,
)
