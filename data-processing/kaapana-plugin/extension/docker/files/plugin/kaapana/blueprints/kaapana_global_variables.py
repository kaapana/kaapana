...
#UPLAOD PORTAL
UPLOAD_PORTAL_PACS = os.getenv("UPLOAD_PORTAL_PACS", None)
UPLOAD_PORTAL_PORT = os.getenv("UPLOAD_PORTAL_PORT", None)
UPLOAD_PORTAL_AE_TITLE = os.getenv("UPLOAD_PORTAL_AE_TITLE", None)
