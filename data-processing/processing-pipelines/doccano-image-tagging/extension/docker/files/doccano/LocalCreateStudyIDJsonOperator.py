...
class LocalCreateStudyIDJsonOperator(KaapanaPythonBaseOperator):
        ...
        for batch_element_dir in batch_folder:
            ...
            with open(metadata_json) as f:
                ...
                if study_id in study_id_dict:
                    study_id_dict[study_id]["metadata"]["series_instance_uids"].append(
                        data["0020000E SeriesInstanceUID_keyword"]
                    )
                else:
    ...
    def __init__(self, dag, name="create-study-id-json", *args, **kwargs):
        super().__init__(
            dag=dag,
            name=name,
