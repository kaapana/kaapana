    ...
    **Outputs**
    ...
    def start(self, ds, **kwargs):
        ...
        for batch_element in batch_dirs:
            ...
            output_nifites = get_all_files_from_dir(output_dir, filter_pattern=r'.*\.nii.*')
            ...
            if len(all_nifties) == 0:
                raise FileNotFoundError("No nifti file found in the directory {} to be used as a base nifti for empty segmentation file".format(input_dir))
            ...
            empty_seg_nifti = nib.Nifti1Image(empty_seg_np, base_nifti.affine, base_nifti.header)
