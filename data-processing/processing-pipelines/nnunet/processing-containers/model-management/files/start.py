...
if __name__ == "__main__":
    ...
    print(f"# install_tasks:   {install_tasks}")
    print(f"# uninstall_tasks:   {uninstall_tasks}")
    print("#")
    print("##################################################")
    print("#")
    ...
    if uninstall_tasks:
        ...
        for uninstall_task in uninstall_tasks:
            ...
            for installed_model in installed_models:
                ...
                for installed_task in installed_tasks_dirs:
                    if installed_task.lower() == uninstall_task.lower():
                        ...
                        rmtree(task_path)
            print("#")
            print(f"# ✓ {uninstall_task} scuessfully uninstalled!.")
            print("#")
            print("# DONE")
