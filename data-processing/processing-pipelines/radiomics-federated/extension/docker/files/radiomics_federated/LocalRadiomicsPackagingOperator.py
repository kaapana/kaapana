...
class LocalRadiomicsPackagingOperator(KaapanaPythonBaseOperator):
    ...
    def start(self, ds, **kwargs):
        ...
        batch_folder = [f for f in glob.glob(os.path.join(dag_run_dir, BATCH_NAME, '*'))]
        ...
        for batch_element_dir in batch_folder:
            ...
            target = os.path.join(output_path, os.path.relpath(batch_element_dir, os.path.join(dag_run_dir, BATCH_NAME)))
