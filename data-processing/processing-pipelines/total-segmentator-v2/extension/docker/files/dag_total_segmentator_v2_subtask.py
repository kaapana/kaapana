...
def move_metadata_json(ds, **kwargs):
    ...
    # print(conf)
    # subtask = conf.get("subtask_name")
    # print('ashis:::::::', subtask)
    # env_update = {}
    # env_update['TASK'] = subtask
    # total_segmentator_1.update_env_vars(env_update)
    # conf["workflow_form"]['TASK'] = subtask
    # print("workflow conf::::ashis", conf["workflow_form"])
    # print("workflow conf keys::::ashis", conf.keys())
    #raise airflow.AirflowSkipException(126)
