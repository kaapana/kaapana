...
for files in WSI_files:
    ...
    try:
        WsiDicomizer.convert(
            load_path, output_dcm_file_path, metadata=metadata, add_missing_levels=True, include_confidential=False
        )
    except Exception as e:
        print(f"Primary conversion failed with error: {e}. Retrying with TiffSlideSource.")
        WsiDicomizer.convert(
            load_path,
            output_dcm_file_path,
...
print(
    "This conversion was done with wsidicomizer as backbone. wsidicomizer: Copyright 2021 Sectra AB, licensed under Apache 2.0. This project is part of a project that has received funding from the Innovative Medicines Initiative 2 Joint Undertaking under grant agreement No 945358. This Joint Undertaking receives support from the European Union’s Horizon 2020 research and innovation programme and EFPIA. www.github.com/imi-bigpicture/wsidicomizer"
)
