...
Custom rights can be created in the `confimap <https://codebase.helmholtz.cloud/kaapana/kaapana/-/blob/0.5.0/services/data-separation/access-information-interface/access-information-interface-chart/templates/configmap.yaml?ref_type=tags>`_ of the **Access Information Interface (AII)** before the platform is build.
...
The following sequence diagram gives a simplified overview of the authorization flow in Kaapana.
