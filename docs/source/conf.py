...
# Workaround to donwload images for local use
sys.path.insert(0, os.path.dirname(__file__))
from download_images import download

download(os.path.join(os.path.dirname(__file__), "img"))
...
latex_documents = [
    (
        master_doc,
        "Kaapana.tex",
        "Kaapana Technical Documentation",
...
man_pages = [(master_doc, "kaapana", "Kaapana Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        author,
        "Kaapana",
        "Build infrastructure for Medical Image Computing.",
        "Miscellaneous",
    ),
]
