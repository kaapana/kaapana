...
.. tabs::
      ...
      .. tab:: Local Dev
        ...
        | **1.a.** either installing and running the build CLI :code:`cd <path-to-kaapana-repo> && pip install -e build_cli/ && kaapana-build` , however it also builds all the other images inside the platform so it can take some more time and storage space.
