...
This is the OpenSearch dashboard. Select "Manage" on the top right menu or "Management" in the menu on the left and then "Index Patterns". Then you should see an entry called "project-<name>". Click on it and on the next page there is a refresh button at the top right corner.
