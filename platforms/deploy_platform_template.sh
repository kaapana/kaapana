...
CREDENTIALS_POSTGRES_AIP_USERNAME="{{ credentials_postgres_aip_username|default('kaapanauser', true) }}"
CREDENTIALS_POSTGRES_AIP_PASSWORD="{{ credentials_postgres_aip_password|default('Kaapana2020', true) }}"

CREDENTIALS_POSTGRES_DICOM_WEB_FILTER_USERNAME="{{ credentials_postgres_aip_username|default('kaapanauser', true) }}"
...
function deploy_chart {
    ...
    --set-string global.credentials_postgres_aip_username="$CREDENTIALS_POSTGRES_AIP_USERNAME" \
    --set-string global.credentials_postgres_aip_password="$CREDENTIALS_POSTGRES_AIP_PASSWORD" \
    --set-string global.credentials_postgres_dicom_web_filter_username="$CREDENTIALS_POSTGRES_DICOM_WEB_FILTER_USERNAME" \
