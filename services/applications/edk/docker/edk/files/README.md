...
Builds the container image under the path by creating a separate buildah pod, and pushes the image to the local registry. By default it does not put the image inside microk8s runtime.
