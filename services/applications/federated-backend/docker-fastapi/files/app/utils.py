...
def json_loads_client_network(db_client_network):
    if db_client_network and db_client_network.allowed_dags is not None:
        db_client_network.allowed_dags = json.loads(db_client_network.allowed_dags)
    if db_client_network and db_client_network.allowed_datasets is not None:
        db_client_network.allowed_datasets = json.loads(db_client_network.allowed_datasets)
