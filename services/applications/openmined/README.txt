...
#Openmined Node
helm install --version 0.1.0-vdev --set global.id="heidelberg" --set global.registry_url="dktk-jip-registry.dkfz.de" --set global.registry_project="/kaapana" --set port=5000 --set grid_network_url=http://10.128.130.139:7000 --set hostname="10.128.130.139" openmined-node kaapana-public/openmined-grid-node
