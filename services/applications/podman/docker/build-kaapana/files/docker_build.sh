...
pip install -c https://raw.githubusercontent.com/hammb/kaapana-constraints/main/constraints-0.2.6.txt -r /kaapana/app/kaapana/build-scripts/requirements.txt
