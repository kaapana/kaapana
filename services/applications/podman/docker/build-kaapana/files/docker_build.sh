...
pip install -c https://raw.githubusercontent.com/kaapana/kaapana/feature/PoC/build-scripts/constraints-0.2.6.txt -r /kaapana/app/kaapana/build-scripts/requirements.txt
