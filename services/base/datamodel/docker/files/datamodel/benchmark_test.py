...
import datamodel.DatamodelB as DatamodelB
import os
import time
import csv
RESUTL_DIR = "/home/ubuntu/results"# "/home/hanno/benchmark"#
INPUT_DIR = 'home/ubuntu/input_dicom'# "/home/hanno/project/kaapana-internal-datamodel/services/base/datamodel/datamodel/test/images/dummy"
#namelist = ["Brugman", "deGrunt", "Evers","Lemmens", "Jacobs", "Zijlemans", "Willemsen", "Hoppenbrouwer", "Heyne"]
namelist = ["Janssen", "Vermeulen", "Janssen", "Janssen", "Janssen", "Janssen", "Janssen", "Janssen", "Janssen"]
time_modelA = 0.0
time_list_A = []
time_list_B = []
function_name = str
...
def write_to_csv():
    ...
    with open(csv_file, 'a+', newline='', encoding='utf-8') as cvsFile:
        ...
        print(function_name, time_list_A, time_list_B)
        time_list_A = []
        time_list_B = []
...
class Testquery(unittest.TestCase):
    ...
    #     datamodel_b = DatamodelB.KaapanaDatamodelB()
    #     datamodel_b.init_db()
    ...
    def test_query_patient(self):
        ...
        patients_b = query_patient(self.datamodel_b, name)
        print(patients_b)
        #self.assertEqual(patients_a[0].family_name, name)
        #self.assertEqual(patients_b[0].meta['00100010']['QueryValue'], name)
        name = namelist[1]
        patients_a = query_patient(self.datamodel_a, name)
        print(patients_a)
        #self.assertEqual(patients_a[0].family_name, name)
    ...
    def test_query_modality(self):
        ...
        print("Number of series_a: ", len(series_a))
        series_b = query_modality(self.datamodel_b, modality)
        print("Number of series_b: ", len(series_b))
    ...
    def test_query_seg(self):
        ...
        print("Number of segmentation a: ", len(segmentation_a))
        segmentation_b = query_seg(self.datamodel_b, name)
        print("Number of segmentation b: ", len(segmentation_b))
    ...
    def test_get_numberof_instances(self):
        ...
        print("Number of number_of_instances_a: ", number_of_instances_a)
        number_of_instances_b = query_number_of_instances(self.datamodel_b, name)
        print("Number of number_of_instances_b: ", number_of_instances_b)
