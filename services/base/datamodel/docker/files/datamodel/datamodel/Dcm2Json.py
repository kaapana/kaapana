...
class Dcm2Json:
    ...
    def start(self, dcm_file):
        ...
        json_file_path = os.path.join(target_dir, "{}.json".format(os.path.basename(dcm_file)))
        ...
        if ret != 0:
            ...
            exit(1)
        self.executeDcm2Json(dcm_file, json_file_path)

        json_dict = self.cleanJsonData(json_file_path)

        manual_tags = Dcm2Json.get_manual_tags(dcm_file)
                    ...
                    if vr == "AE":
                        ...
                        try:
                            ...
                            if date_time_string is not None:
                                ...
                                date_time_formatted = self.convert_time_to_utc(date_time_formatted,
    ...
    def cleanJsonData(self, path):
        ...
        new_meta_data["timestamp_arrived_datetime"] = self.convert_time_to_utc(
