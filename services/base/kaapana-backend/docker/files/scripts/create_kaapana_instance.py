...
with SessionLocal() as db:
    try:
        ...
        if not db_kaapana_instances:
            ...
            db_client_kaapana_instance = create_and_update_client_kaapana_instance(db, client_kaapana_instance=client_kaapana_instance)
        ...
        for db_kaapana_instance in db_kaapana_instances:
            if not db_kaapana_instance.remote:
                if db_kaapana_instance.instance_name != settings.instance_name:
                    ...
                    create_and_update_client_kaapana_instance(db, client_kaapana_instance=client_kaapana_instance, action="update")
