...
def get_adapter_for_workflow(workflow_type: str, forwarded_headers: dict) -> 'WorkflowEngineBase':
    """
...
def monitor_workflow(self, workflow_type: str, forwarded_headers: dict, workflow_run_id: int, workflow_identifier: str, external_id: str):
    ...
    try:
        ...
        adapter: WorkflowEngineBase = get_adapter_for_workflow(workflow_type, forwarded_headers)
