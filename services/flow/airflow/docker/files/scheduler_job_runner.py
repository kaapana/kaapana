...
class SchedulerJobRunner(BaseJobRunner, LoggingMixin):
    ...
    def _process_executor_events(self, session: Session) -> int:
        ...
        for ti in tis:
            ...
            ti_requeued = (
                ...
                or self.job.executor.has_task(
                    ti
                )  # This scheduler has this task already
            )
    ...
    def _emit_pool_metrics(self, session: Session = NEW_SESSION) -> None:
        ...
        for pool_name, slot_stats in pools.items():
            ...
            Stats.gauge(
                "pool.queued_slots", slot_stats["queued"], tags={"pool_name": pool_name}
            )
            Stats.gauge(
                "pool.running_slots",
                slot_stats["running"],
        ...
        for attempt in run_with_db_retries(logger=self.log):
            with attempt:
                ...
                try:
                    ...
                    to_reset = self.job.executor.try_adopt_task_instances(
