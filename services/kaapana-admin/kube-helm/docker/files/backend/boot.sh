...
# DEV cmd
uvicorn main:app --app-dir /home/kaapana/services/kaapana-admin/kube-helm/docker/files/backend/app --reload --host 0.0.0.0 --port 5000 --workers 4 --root-path $APPLICATION_ROOT
