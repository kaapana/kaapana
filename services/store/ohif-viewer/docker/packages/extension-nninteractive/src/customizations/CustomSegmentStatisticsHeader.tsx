...
export const CustomSegmentStatisticsHeader = ({
        ...
        <div className="flex">
          <Tooltip>
            <TooltipTrigger asChild>
              <Button variant="ghost" size="sm" className="text-primary flex items-center px-0">
  ...
  const max = Math.max(value.maxMajor, value.maxMinor);
  const min = Math.min(value.maxMajor, value.maxMinor);
