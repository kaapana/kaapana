...
export const DataRow: React.FC<DataRowProps> = ({
  ...
  return (
    <div
      ref={rowRef}
      className={classNames('flex flex-col', !isVisible && 'opacity-60', className)}
    >
      <div
      ...
      >
        ...
        <div className="relative ml-2 flex items-center space-x-1">
          ...
          <Button
            ...
            variant="ghost"
            className={`h-6 w-6 transition-opacity ${
              isSelected || !localMeasurementVisible
                ? 'opacity-100'
                : 'opacity-0 group-hover:opacity-100'
            }`}
            aria-label={localMeasurementVisible ? 'Hide measurement' : 'Show measurement'}
            onClick={e => {
              e.stopPropagation();
