...
export const SegmentationSegments = ({ children = null }: { children?: React.ReactNode }) => {
  ...
  const segments = representation ? Object.values(representation.segments) : [];
      ...
      >
        ...
        >
          {segments.map(segment => {
            ...
            const isMeasurementVisible = !!commandsManager.run('getSegmentMeasurementVisibility', {
            ...
            const DataRowComponent = (
              <DataRow
                ...
                onToggleMeasurement={() =>
                  onToggleSegmentMeasurement?.(segmentation.segmentationId, segmentIndex)
                }
                onToggleLocked={() =>
