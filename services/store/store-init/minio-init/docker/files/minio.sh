...
mc cp readme_tcia.txt kaapana/uploads/tcia/
...
mc admin config set kaapana notify_webhook:tciadownload queue_limit="0"  endpoint="http://airflow-service.$SERVICES_NAMESPACE.svc:8080/flow/kaapana/api/trigger/service-tcia-download" queue_dir=""
...
mc event add kaapana/uploads/dicoms arn:minio:sqs::tciadownload:webhook --event put --suffix .tcia
