...
mc admin config set kaapana notify_webhook:dicomsupload queue_limit="0"  endpoint="http://airflow-service.flow.svc:8080/flow/kaapana/api/trigger/minio-dicom-upload" queue_dir=""
