      ...
      <v-row dense>
        ...
        <v-col cols="12">
          <v-card>
            ...
            <v-card-text>
              <v-icon class="my-2" large>mdi-numeric-1-circle</v-icon>&nbsp; Make sure
              your data is correctly formatted for the upload.
              <v-btn color="primary" dark icon @click.stop="infoDialog = true">
                <v-icon color="primary" dark> mdi-information </v-icon>
              </v-btn>
              <br />
              ...
              <v-dialog v-model="infoDialog" width="60vw">
                <v-card>
                  ...
                  <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn color="primary" dark @click="() => (infoDialog = false)">
                      Got it!
                    </v-btn>
                  </v-card-actions>
                </v-card>
