    ...
    async updateData(query = {}, useLastquery = false) {
      ...
      getAggregatedSeriesNum({
        ...
        loadPatients({
          ...
          query: this.searchQuery,
          sort: !this.$store.getters.queryItem ? this.settings.datasets.sort : '_score',
          sortDirection: !this.$store.getters.queryItem ? this.settings.datasets.sortDirection: 'desc',
