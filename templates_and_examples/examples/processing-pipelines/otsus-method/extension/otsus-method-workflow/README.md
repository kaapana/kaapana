...
Custom operators defitions that are used inside the DAG. You can use [the existing operators provided in Kaapana](https://kaapana.readthedocs.io/en/stable/development_guide/legacy/operators.html) directly by importing them in your DAG definition file.
