...
Memory: The offline installer tarball is downloaded as a single blob that is held
entirely in memory while it is pulled. The host needs free RAM of at least the size
of the packaged tarball.
"""
