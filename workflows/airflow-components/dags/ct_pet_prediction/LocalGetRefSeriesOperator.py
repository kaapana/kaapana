        ...
        for batch_element_dir in batch_folder:
            ...
            if len(dcm_files) > 0:
                ...
                if self.search_policy == 'pet_ct':
                    ...
                    patient_uid = incoming_dcm[0x0010, 0x0020].value
                    ct_patient_uid = patient_uid.replace("PET","CT")
                    print("PET Patient_UID: {}".format(patient_uid))
                    print("CT  Patient_UID: {}".format(ct_patient_uid))
                    pacs_series = client.search_for_series(search_filters={'00100020': ct_patient_uid, '00080060': self.modality.upper()})
                    if len(pacs_series) != 1:
                        print("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
                        print("")
                        print("Could not identify the searched modality: {} from the PatientUID: {} !".format(self.modality, patient_uid))
