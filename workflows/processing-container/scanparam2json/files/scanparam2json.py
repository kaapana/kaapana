...
keywords_basic = ["StudyInstanceUID", "SeriesInstanceUID", "StudyDescription", "SeriesDescription",
                "Modality", "AcquisitionDateTime", "ProcedureCodeSequence", "Manufacturer", "ManufacturerModelName",
                "DeviceSerialNumber", "SoftwareVersions", "ProtocolName", "BodyPartExamined"]


# define keywords to extract
keywords_ct = ["StudyInstanceUID", "SeriesInstanceUID","StudyDescription", "SeriesDescription",
            "Modality", "AcquisitionDateTime","ProcedureCodeSequence","Manufacturer", "ManufacturerModelName",
            "DeviceSerialNumber", "SoftwareVersions", "ProtocolName","BodyPartExamined",
            "Rows", "Columns", "PixelSpacing","SliceThickness", "PatientPosition",
            "ScanOptions", "KVP","DataCollectionDiameter",
            ...
            "ConvolutionKernel",
            "WaterEquivalentDiameter", "WaterEquivalentDiameterCalculationMethodCodeSequence"
            "RevolutionTime"
            "SingleCollimationWidth", "TotalCollimationWidth",
            "TableSpeed", "TableFeedPerRotation",
            "SpiralPitchFactor",
            "DataCollectionCenterPatient", "ReconstructionTargetCenterPatient",
            "ExposureModulationType",
            "EstimatedDoseSaving",
            "CTDIvol",
            "CTDIPhantomTypeCodeSequence",
            "EnergyWeightingFactor", "CTAdditionalXRaySourceSequence",
...
keywords_mr = ["StudyInstanceUID", "SeriesInstanceUID", "StudyDescription", "SeriesDescription",
                "Modality", "AcquisitionDateTime", "ProcedureCodeSequence", "Manufacturer", "ManufacturerModelName",
                "DeviceSerialNumber", "SoftwareVersions", "ProtocolName", "BodyPartExamined",
                "Rows", "Columns", "PixelSpacing","SliceThickness", "PatientPosition",
                "ScanningSequence","SequenceVariant","ScanOptions","MRAcquisitionType","SequenceName",
                "AngioFlag","RepetitionTime","EchoTime","InversionTime", "NumberOfAverages", "ImagingFrequency", "ImagedNucleus",
                "EchoNumbers", "MagneticFieldStrength", "NumberOfPhaseEncodingSteps", "EchoTrainLength", "PercentSampling",
                "PercentPhaseFieldOfView", "PixelBandwidth", "TriggerTime", "ReconstructionDiameter", "ReceiveCoilName", "TransmitCoilName",
                "AcquisitionMatrix", "InPlanePhaseEncodingDirection", "FlipAngle", "VariableFlipAngleFlag", "SAR", "dBdt", "B1rms"
                # "StudyID", "SeriesNumber", "AcquisitionNumber", "InstanceNumber",
                # "ImagePositionPatient", "ImageOrientationPatient", "FrameOfReferenceUID", "PositionReferenceIndicator",
                # "SliceLocation", "SamplesPerPixel", "PhotometricInterpretation",
                # "BitsAllocated", "BitsStored", "HighBit",
...
json_file_path = os.path.join(batch_output_dir, "scan_parameters_{}.json".format(datetime.now().strftime('%Y-%m-%d %H:%M:%S.%f')))
